...
public record PagedResult<T> (List<T> data, long totalElements, int pageNumber, int totalPages,
  ...
  public PagedResult(Page<T> page) {
    this(page.getContent(), page.getTotalElements(), page.getNumber() + 1, page.getTotalPages(),
